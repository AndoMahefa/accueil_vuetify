...
export default {
  ...
  data() {
    return {
      ...
      holidays: ["2024-12-25", "2025-01-01"], // Jours fériés
      allTimeSlots: [
          "09:00",
          "09:30",
          "10:00",
  ...
  methods: {
      ...
      isAllowedDate(date) {
        const isoDate = this.toISODate(date)
          ...
          return day !== 0 && day !== 6 && !this.holidays.includes(isoDate);
      },
      ...
      async loadAvailableSlots() {
        ...
        try {
          ...
          console.log("selectedDate: " + date + " selectedService: " + this.selectedService)
            ...
            // const allSlots = ["09:00", "09:30", "10:00", "10:30", "11:00", "11:30", "12:00"]; // Liste complète des créneaux
            const allSlots = this.allTimeSlots; // Liste complète des créneaux
